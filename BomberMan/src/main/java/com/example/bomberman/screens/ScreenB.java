...
public class ScreenB {
    ...
    public void createEnemigos() {
        for (int i = 0; i < 1; i++) {
            Enemigos enemy = new Enemigos(this.canvas, "/Enemigos/Color_0" + i + ".png", 230, 340, bomberMan, obstacles, obstaclesToBreak);
            shadows.add(enemy);
    ...
    private void loadScreenC() {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/com/example/bomberman/ventanaTercerNivel.fxml"));
            Stage stage = new Stage();
            stage.setTitle("Nivel 2 - 3");
